...
label_1 = Label(root, text='Digite 1 número', background='green').grid(row=1, column=0)
entry_field_1 = Entry(root, text='Número 1', width=10)
entry_field_1.grid(row=1, column=1)

label_2 = Label(root, text='Digite 2 número', background='green').grid(row=2, column=0)
entry_field_2 = Entry(root, text='Número 2', width=10)
entry_field_2.grid(row=2, column=1)

selected_operation = IntVar()

label_3 = Label(root, text='Escolha a operação desejada', background='green').grid(row=3, column=0, columnspan=2)
label_4 = Label(root, text='Resultado').grid(row=7, column=0)


sum_button = Radiobutton(root, text='+',background='green', variable=selected_operation, value=1)
sum_button.grid(row=4, column=0)

subtraction_button = Radiobutton(root, text='-', background='green', variable=selected_operation, value=2)
subtraction_button.grid(row=4, column=1)

multiplication_button = Radiobutton(root, text='x', background='green', variable=selected_operation, value=3)
multiplication_button.grid(row=5, column=0)

division_button = Radiobutton(root, text='/', background='green', variable=selected_operation, value=4)
